...
void testBoards() {
  ...
  board10.squares[TOP][MID] = MINIMAX_O_SQUARE;
  ...
  board10.squares[BOT][LFT] = MINIMAX_X_SQUARE;
  ...
  board12.squares[BOT][LFT] = MINIMAX_O_SQUARE;
  ...
  board14.squares[TOP][RGT] = MINIMAX_O_SQUARE;
  ...
  board15.squares[MID][RGT] = MINIMAX_O_SQUARE;
